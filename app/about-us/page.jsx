  ...
  return (
    <Container>
      ...
      <div className={styles.content}>
        ...
        <p>
          Мастерская подарков Awebuket приносит радость уже 6 год 
          Мы находимся по адресу: Ватутина, 16, вывеска «Мастерская 
          подарков», режим работы с 10 до 20:00 ежедневно, без обеда и выходных
        </p>
        <p>У нас:</p>
        <ul>
          <li>
          ...
          <li>Упаковка ваших подарков У нас качество! В 
            нас можно не сомневаться, мы не подведём и 
            сделаем все на высшем уровне!</li>
        </ul>
      </div>
