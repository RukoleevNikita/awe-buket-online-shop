        ...
        <div className={styles.delivery}>
          ...
          <div className={styles.delivery_wrapper}>
            <div className={styles.delivery_description}>
              ...
              <p>
                Обработка заявок: <br />
                <span>&#8195;&#8195;C 7:00 до 23:00, работаем без выходных </span>
              </p>
              <p>
                Выполняем срочные заказы: <br />
                <span>&#8195;&#8195;Доставим подарок в интервале от 1 до 4 часов с момента размещения заказа</span>
              </p>
              <p>
                Оплата: <br />
                <span>
                ...
                <span>&#8195;&#8195;Переводом или наличными курьеру при получении</span>
              </p>
              <p>
                Доставка: <br />
