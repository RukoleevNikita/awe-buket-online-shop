    ...
    <Container>
      <MainWrapper>
        <div className={styles.corporativeClients}>
          <h1 className={styles.corporativeClients_title}>
            Корпоративным клиентам</h1>
          <div className={styles.corporativeClients_description}>
            <p>
              Наша компания Awebuket уже 5 лет работает на 
              рынке съедобных подарков в городе Омске. Мы являемся лидерами
              в этом деле.
            </p>
            <p>
              У нас команда из фудфлористов, мы беремся 
              за корпоративные заказы любой сложности и любых объемов. У нас
            ...
            <div>
              ...
              <p>
                Юридическое лицо:{' '}
                <span>Индивидуальный предприниматель 
                  Чулошникова Мария Вячеславовна ИНН 550726479371</span>
              </p>
              <p>
